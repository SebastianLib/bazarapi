...
import { OrderProductsEntity } from './entities/orders-products.entity';
...
export class OrdersService {
  constructor(
    ...
    @InjectRepository(OrderProductsEntity) private readonly opRepository: Repository<OrderProductsEntity>,
  ...
  remove(id: number) {
    return `This actioon removes a #${id} order`;
  }
